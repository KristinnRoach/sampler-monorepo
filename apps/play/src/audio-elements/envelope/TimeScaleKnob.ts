 ...
 */
export const TimeScaleKnob = (config: TimeScaleKnobConfig & { label?: string }): HTMLElement => {
  const { onChange: onTimeScaleChange, envelopeType, label = "Time Scale", ...knobConfig } = config;
