  ...
  namespace JSX {
    interface IntrinsicElements {
      "knob-element": {
        ...
        "onknob-change"?: JSX.EventHandlerUnion<HTMLElement, CustomEvent<KnobChangeEventDetail>>;
        "on:knob-change"?: JSX.EventHandlerUnion<HTMLElement, CustomEvent<KnobChangeEventDetail>>;
