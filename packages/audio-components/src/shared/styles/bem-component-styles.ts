 ...
 */
export const bemClass = (block: string, element?: string, modifier?: string): string => {
  let className = block;
 ...
 */
export const bemConditional = (baseClass: string, conditions: Record<string, boolean>): string => {
