...
// Update LabelContent type to support functions that return content
...
// Custom checkbox appearance type
type CustomCheckbox = {
...
export const createSlider = (
  ...
  return div(
    ...
    // Use the new helper function for label content
...
export const createCheckbox = (
  ...
  if (customCheckbox) {
    // Create checkbox with custom appearance
    return div(
      {
