...
<g id="p1">
  <rect x="${kw * 0.075}" y="${kh * 0.075}" width="${kw * 0.85}" height="${kh * 0.85}" rx="${mm * 0.1}" ry="${mm * 0.1}" fill="#000"/>
  <rect x="${kw * 0.1}" y="${kh * 0.1}" width="${kw * 0.8}" height="${kh * 0.8}" rx="${mm * 0.1}" ry="${mm * 0.1}" fill="${this.coltab[1]}"/>
</g>
<g id="p2">
  <circle cx="${kw * 0.5}" cy="${kh * 0.5}" r="${mm * 0.35}" stroke="#000" stroke-width="${mm * 0.03}" fill="${this.coltab[0]}" filter="url(#f1)"/>
  <circle cx="${kw * 0.5}" cy="${kh * 0.5}" r="${mm * 0.27}" stroke="#000" stroke-width="${mm * 0.03}" fill="#000" filter="url(#f1)"/>
  <rect x="${kw * 0.075}" y="${kh * 0.075}" width="${kw * 0.85}" height="${kh * 0.85}" rx="${mm * 0.1}" ry="${mm * 0.1}" fill="url(#g1)"/>
</g>
<use href="#p1" y="${kh}"/>
<use href="#p2" y="${kh}"/>
...
`;
        ...
        keydown(e) {
          ...
          if (k >= 0) {
            ...
            if (this.currentKey != k) {
              this.currentKey = k;
              this.setdispvalues(1, k); // ! KIDDI ← Add visual feedback ?
        ...
        keyup(e) {
          ...
          if (k >= 0) {
            k += m;
            this.currentKey = -1;
            this.setdispvalues(0, k); // ! KIDDI ← Add visual feedback ?
