...
export class SamplePlayer implements ILibInstrumentNode {
   ...
   */
  protected storeParamValue(paramId: string, value: any, delay = this.#debounceMs): void {
   ...
   */
  getStoredParamValue<T extends number | string>(paramId: string, defaultValue: T): T {
  ...
  getKeytrackLoopAmount = () => {
    this.#keytrackLoopAmount ??= this.getStoredParamValue("keytrackLoopAmount", 0);
