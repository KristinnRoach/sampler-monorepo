export abstract class BaseEventTarget extends EventTarget {
  // Only maintain utility methods not available in standard EventTarget
  ...
  clearEventListeners(): void {
    // You'd need the browser API to get all listeners, which isn't standardized
    // Consider maintaining a separate list of registered event types
  }
}

// // TODO: Find out if we need to ensure compatibility with both
// // the web standard EventTarget and the the Node.js EventTarget
// // FIRST TODO: Ensure compatibility with the web standard EventTarget
// // and that we are not adding redundant code or causing conflicts
